from static_parser.parser import parse_doxygen_output
...
from query_processing.processor import process_query
from code_retrieval.retriever import CodeRetriever
from prompt_construction.constructor import construct_prompt
...
def analyze_cpp_project(project_path: str, query: str) -> str:
    ...
    # Process the query
    query_processor = Query_Processor(llm, graph_db_mgr, source_code_vdb_mgr, call_graph)
